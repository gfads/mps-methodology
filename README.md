...
The time series used in the research can be found [here](time_series). Also, we also [plot](time_series/plots)
all-time series and create a [description file](time_series/series-description/).
